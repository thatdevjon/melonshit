...
// GA
    ...
    (function (d, s, id) {
        ...
        js.id = id;
        js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.8&appId=1546633755566130";
    ...
    // TYPD
    $(function () {
        $(".home-features h2 span").typed({
            strings: ["different?", "awesome?", "reliable?", "the best?", "amazing?", "unbeatable?", "your host of choice?", "number one?"],
            typeSpeed: 50,
            startDelay: 100,
            loop: true,
            backDelay: 3000,
